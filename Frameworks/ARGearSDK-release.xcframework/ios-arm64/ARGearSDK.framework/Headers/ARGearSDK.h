 ...
 *
 *  @file       ARGearSDK.h
 *  @brief      Umbrella(Master) header of framework
...
/** Project version number for ARGearSDK. */
FOUNDATION_EXPORT double ARGearSDKVersionNumber;

/** Project version string for ARGearSDK. */
FOUNDATION_EXPORT const unsigned char ARGearSDKVersionString[];
